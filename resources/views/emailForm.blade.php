@include('layouts.header')
    <main class="form-signin w-100 mx-auto">
        ...
        <form name="otpForm" method="post" action="{{route('user.verifyEmailOtp')}}" autocomplete="off">
            @csrf
            <h1 style="color:#ed4b60;text-align: left;" class="h3 mb-3 fw-normal">Email Verification</h1>
            ...
            <button type="submit" style="background-color: #ed4b60;border-radius:30px;color:white;" class="w-100 btn mt-5" name="submit"><b>Verify Email</b></button>
