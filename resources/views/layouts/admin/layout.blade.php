...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="{{URL::asset('assets/admin/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet" type="text/css" />
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link @if(Request::segment(3) == 'transactions') active @endif" href="{{route('admin.transactions')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								...
								<div class="menu-item">
									<a class="menu-link @if(Request::segment(3) == 'gallery' || Request::segment(3) == 'list-gallery') active @endif"
								...
								<div class="menu-item">
									<a class="menu-link @if(Request::segment(3) == 'mobile-prefix') active @endif" href="{{route('admin.mobilePrefix')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
											<span class="svg-icon svg-icon-2">
										...
										<span class="menu-title">Mobile Prefix</span>
									</a>
								</div>
								<div class="menu-item">
									<a class="menu-link @if(Request::segment(3) == 'manage-credit') active @endif"
										href="{{route('admin.manageCredit', ['id' => 1])}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="menu-title">Manage Credit</span>
									</a>
								</div>
								<div class="menu-item">
									<a class="menu-link @if(Request::segment(3) == 'change-password') active @endif"
								...
								<div class="d-flex align-items-stretch" id="kt_header_nav">
									...
									<div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
										...
										<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											...
											<div class="menu-item me-lg-1">
												<a class="menu-link py-3 @if(Request::segment(3) == 'hostess') active @endif" href="{{route('admin.hostessList')}}">
													<span class="menu-title">Hostess</span>
												</a>
											</div>
											<div class="menu-item me-lg-1">
												<a class="menu-link py-3 @if(Request::segment(3) == 'transactions') active @endif"
													href="{{route('admin.transactions')}}">
													<span class="menu-title">Transactions</span>
												</a>
											</div>
											<div class="menu-item me-lg-1">
												<a class="menu-link py-3 @if(Request::segment(3) == 'gallery' || Request::segment(3) == 'list-gallery') active @endif"
													href="{{route('admin.gallery')}}">
													<span class="menu-title">Gallery</span>
												</a>
											</div>
											<div class="menu-item me-lg-1">
												<a class="menu-link py-3 @if(Request::segment(3) == 'mobile-prefix') active @endif" href="{{route('admin.mobilePrefix')}}">
													<span class="menu-title">Mobile Prefix</span>
												</a>
											</div>
											<div class="menu-item me-lg-1">
												<a class="menu-link py-3 @if(Request::segment(3) == 'manage-credit') active @endif"
													href="{{route('admin.manageCredit', ['id' => 1])}}">
													<span class="menu-title">Manage Credit</span>
												</a>
											</div>
											<div class="menu-item me-lg-1">
												<a class="menu-link py-3 @if(Request::segment(3) == 'change-password') active @endif"
													href="{{route('admin.changePassword')}}">
													<span class="menu-title">Change Password</span>
												</a>
											</div>
...
-->
										...
										{{-- <div class="d-flex align-items-center ms-1 ms-lg-3">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
												<!--begin::Heading-->
												<div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{URL::asset('assets/admin/media/misc/pattern-1.jpg') }}')">
													<!--begin::Title-->
										...
										{{-- <div class="d-flex align-items-center ms-1 ms-lg-3">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
												<!--begin::Heading-->
												<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('assets/admin/media/misc/pattern-1.jpg')">
													<!--begin::Title-->
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												...
												<img src="{{ URL::asset('upload/user/profile/' . Auth::user()->profilepic) }}" alt="user" />
												@else
												<img src="{{ URL::asset('upload/user/profile/default.png') }}" class="rounded-circle mr-1" alt="Profile Picture"
													width="40" height="40">
												@endif
												{{-- <img src="{{ URL::asset('upload/' . Auth::user()->image) }}" alt="profile pic" > --}}
											</div>
											<!--begin::Menu-->
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															{{-- <img src="{{ URL::asset('upload/' . Auth::user()->image) }}" alt="profile pic" > --}}
															@if(Auth::user()->profilepic != null || Auth::user()->profilepic != '')
															<img alt="Logo" src="{{ URL::asset('upload/user/profile/' . Auth::user()->profilepic) }}" />
															@else
															<img src="{{ URL::asset('upload/user/profile/default.png') }}" class="rounded-circle mr-1" alt="Profile Picture"
																width="40" height="40">
															@endif
														...
														<div class="d-flex flex-column">
															...
															<a href="mailto:{{ Auth::user()->email }}" class="fw-bold text-muted text-hover-primary fs-7">{{ Auth::user()->email }}
															</a>
														</div>
														<!--end::Username-->
													</div>
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="#" target="_blank" class="text-gray-800 text-hover-primary">Hostess</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
		...
		<script src="{{URL::asset('assets/admin/plugins/custom/datatables/datatables.bundle.js') }}"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{{URL::asset('assets/admin/js/custom/apps/user-management/users/list/export-users.js') }}"></script>
		<script src="{{URL::asset('assets/admin/js/custom/apps/user-management/users/list/add.js') }}"></script>
		<script src="{{URL::asset('assets/admin/js/custom/widgets.js') }}"></script>
		<script src="{{URL::asset('assets/admin/js/custom/apps/chat/chat.js') }}"></script>
		<script src="{{URL::asset('assets/admin/js/custom/modals/create-app.js') }}"></script>
		<script src="{{URL::asset('assets/admin/js/custom/modals/upgrade-plan.js') }}"></script>
