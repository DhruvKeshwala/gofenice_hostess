...
@section('title', 'Transactions | Hostess')
    ...
    function deleteTransaction(id) {
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    url: "{{url(app()->getLocale() . '/admin/delete_transaction') }}",
                    type: "POST",
                    data: {
                        id: id,
                        '_token': '{{ csrf_token() }}',
...
@section('js')
    <script src="{{URL::asset('assets/admin/js/custom/apps/user-management/transaction/list/transaction.js') }}"></script>
