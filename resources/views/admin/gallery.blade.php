            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-gallery-table-filter="search"
                ...
                <div class="card-toolbar">
                            ...
                            <div class="px-7 py-5" data-kt-gallery-table-filter="form">
                                <div class="mb-10">
                                    ...
                                    <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                        ...
                                        data-kt-gallery-table-filter="role" data-hide-search="true">
                                        <option></option>
                                ...
                                <div class="mb-10">
                                    ...
                                    <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                        data-placeholder="Select option" data-allow-clear="true"
                                        data-kt-gallery-table-filter="two-step" data-hide-search="true">
                                        <option></option>
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="reset"
                                        ...
                                        data-kt-menu-dismiss="true" data-kt-gallery-table-filter="reset">Reset</button>
                                    <button type="submit" class="btn btn-primary fw-bold px-6"
                                        data-kt-menu-dismiss="true" data-kt-gallery-table-filter="filter">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end align-items-center d-none"
                        ...
                        <button type="button" class="btn btn-danger" data-kt-gallery-table-select="delete_selected">Delete
                            Selected</button>
                    </div>
...
@section('js')
<script src="{{URL::asset('assets/admin/js/custom/apps/user-management/gallery/list/gallery.js') }}"></script>
